...
def conv_block(in_chan, out_chan, stride=1):
    return nn.Sequential(
        nn.Conv3d(in_chan, out_chan, kernel_size=3, padding=1, stride=stride, dilation=1),
...
class UNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.dec3 = conv_stage(304, 32)
        self.dec2 = conv_stage(272, 16)
        self.dec1 = conv_stage(352, 16)
