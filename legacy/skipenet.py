...
class UNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.dec4 = conv_stage(368, 64)
        self.dec3 = conv_stage(176, 32)
        self.dec2 = conv_stage(80, 16)
    ...
    def forward(self, x):
        ...
        dec4 = self.dec4(torch.cat((enc4, enc3dec4, enc2dec4, enc1dec4, F.interpolate(enc5, enc4.size()[2:], mode='trilinear', align_corners=False)), 1))
        dec3 = self.dec3(torch.cat((enc3, enc2dec3, enc1dec3,  F.interpolate(dec4, enc3.size()[2:], mode='trilinear', align_corners=False)), 1))
        dec2 = self.dec2(torch.cat((enc2, enc1dec2, F.interpolate(dec3, enc2.size()[2:], mode='trilinear',  align_corners=False)), 1))
