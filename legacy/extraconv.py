...
class UNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.decs4 = extra_conv_stage(368, 64)
        self.dec4 = conv_stage(64, 64)
        self.decs3 = extra_conv_stage(304, 32)
        self.dec3 = conv_stage(32, 32)
        self.decs2 = extra_conv_stage(272, 16)
        self.dec2 = conv_stage(16, 16)
        self.decs1 = extra_conv_stage(352, 8)
        self.dec1 = conv_stage(8, 8)
    ...
    def forward(self, x):
        ...
        dec3_1 = torch.cat((enc3, enc2dec3, enc1dec3,  F.interpolate(dec4, enc3.size()[2:], mode='trilinear', align_corners=False)), 1)#176
